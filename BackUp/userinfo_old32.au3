...
#AutoIt3Wrapper_Res_Fileversion=0.6.0.2
...
Opt("GUICloseOnESC", 0)
;Opt("GUICoordMode", 2)
Opt("GUIResizeMode", 768) ;0=no resizing, <1024 special resizin
...
GUICtrlCreateGroup("Functions", $guiWidth-$buttonPadding-$buttonWidth, $buttonPadding, $buttonWidth + (2 * $buttonPadding), $guiHeight) ;Create Functions group
...
$top += 25
$listGroups = GUICtrlCreateListView("Groupname|samAccountName|Group type|Member of|Scope", $col1LabelLeft, $top, 2 * $labelWidth + 2 * $valueWidthLong + 3 * $cellPadding, 300)
...
$radio3 = GUICtrlCreateRadio("First name", 270, 35, 120, 20)
...
Func compareGroup($compareUser = "")
	...
	For $name2 In $vergleichsgruppen ; go through all the groups of comparison Users
		$flag = 0
