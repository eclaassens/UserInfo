...
$valueWidthLong = 300 ; default value width
$valueWidthShort = 20
...
$lblLastUpdate = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidthShort , $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Valid till:", $col1ValueLeft + ($valueWidthShort), $top, $labelWidth / 2, $labelHeight)
$lblExpiration = GUICtrlCreateLabel("", $col1ValueLeft + ($valueWidthShort ) + ($labelWidth / 2), $top, $valueWidthShort , $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)
...
$lblPWChangeDate = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidthLong, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Locked/Deact:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblLocked = GUICtrlCreateLabel("", $col1ValueLeft, $top, 30, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("/", $col1ValueLeft + 30, $top, 5, $labelHeight)
$lblDeactivated = GUICtrlCreateLabel("-", $col1ValueLeft + 40, $top, 50, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)
...
$lbl_erzeugt = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidthLong, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Failed count:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblBadLoginCount = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidthLong / 4, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Last logon:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblLastLogon = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidthLong, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)
...
$lblHomeDrive = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidthLong, $valueHeight, $SS_SUNKEN)
GUICtrlSetFont(-1, -1, 800)
	...
	For $oACE In $oACL
		If ($oACE.ObjectType = $USER_CHANGE_PASSWORD) And (($oACE.Trustee = "Everyone") Or ($oACE.Trustee = "Iedereen")) Then
			If ($oACE.AceType = $ADS_ACETYPE_ACCESS_ALLOWED_OBJECT) Then
				GUICtrlSetData($lblPWChangeDate, "Allowed")
				GUICtrlSetColor($lblPWChangeDate, 0x00aa00)
			Else
				GUICtrlSetData($lblPWChangeDate, "Locked")
				GUICtrlSetColor($lblPWChangeDate, 0xff0000)
			EndIf
		EndIf
	Next
