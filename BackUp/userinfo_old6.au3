...
$col2ValueLeft = 480 ; Start  second value
...
$lblName = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("UserID:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblUserId = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Title:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_anrede = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("OU:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_ou = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Telephone:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_telefon = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Department:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblDepartment = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Domain:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblDomain = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Email:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_email = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Location:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_ort = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Address:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_adresse = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Room:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_raum = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$breite4 = 330
$top += 20
GUICtrlCreateLabel("Last update:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblLastUpdate = GUICtrlCreateLabel("", $col1ValueLeft, $top, 130, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
$lblPwRequired = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("PW Change:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_change = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
$lbl_erzeugt = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Failed count:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_errorcount = GUICtrlCreateLabel("", $col1ValueLeft, $top, 85, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Last logon:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_login = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Homedirectory:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_homeverz = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Homedrive:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_homelauf = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Loginscript:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblLogonScript = GUICtrlCreateLabel("", $col1ValueLeft, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Profile Path:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lbl_profil = GUICtrlCreateLabel("", $col2ValueLeft, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
#EndRegion
