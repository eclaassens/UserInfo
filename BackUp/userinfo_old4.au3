...
GUICtrlCreateGroup("Functions", 820, 5, 3*$buttonWidth, 770) ;Create Functions group
...
$top += 60
$bn_userzaehler = GUICtrlCreateButton("Count Users of Department", $buttonLeft, $top, $buttonWidth, $buttonNormalHeight)
...
$top = 10
GUICtrlCreateLabel($texts[$language][20], $reihe1, $top, 90, 17)
$lbl_name = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)
GUICtrlCreateLabel($texts[$language][21], $reihe3, $top, $breite3, 17)
$lblUserId = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][22], $reihe1, $top, 90, 17)
$lbl_anrede = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][24], $reihe1, $top, 90, 17)
$lbl_ou = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][25], $reihe3, $top, $breite3, 17)
$lbl_telefon = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][26], $reihe1, $top, 69, 17)
$lblDepartment = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][27], $reihe3, $top, $breite3, 17)
$lblDomain = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][28], $reihe1, $top, 28, 17)
$lbl_email = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][29], $reihe3, $top, 69, 17)
$lbl_ort = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][30], $reihe1, $top, 90, 17)
$lbl_adresse = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][31], $reihe3, $top, 69, 17)
$lbl_raum = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$breite4 = 330
$top += 90
GUICtrlCreateLabel($texts[$language][33], $reihe1, $top, 90, 17)
$lbl_aenderung = GUICtrlCreateLabel("", $reihe2, $top, 130, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][34], $reihe1 + 220, $top, 55, 17)
$lbl_expiration = GUICtrlCreateLabel("", $reihe1 + 280, $top, 130, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][35], $reihe3, $top, $breite3, 17)
$lbl_pwreq = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20

GUICtrlCreateLabel($texts[$language][36], $reihe3, $top, $breite3, 17)
$lbl_change = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][37], $reihe1, $top, 85, 17)
$lblLocked = GUICtrlCreateLabel("", $reihe2, $top, 30, 17)
GUICtrlSetFont(-1, -1, 800)
GUICtrlCreateLabel("/", $reihe2 + 30, $top, 5, 17)
$lbl_deakt = GUICtrlCreateLabel("-", $reihe2 + 40, $top, 50, 17)
GUICtrlSetFont(-1, -1, 800)

$bn_unlock = GUICtrlCreateButton($texts[$language][38], 200, $top - 4, 90, 20)

GUICtrlCreateLabel($texts[$language][39], $reihe3, $top, $breite3, 17)
$lbl_erzeugt = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][40], $reihe1, $top, 85, 17)
$lbl_errorcount = GUICtrlCreateLabel("", $reihe2, $top, 85, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][41], $reihe3, $top, $breite3, 17)
$lbl_login = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][42], $reihe1, $top, 89, 17)
$lbl_homeverz = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][43], $reihe3, $top, $breite3, 17)
$lbl_homelauf = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][44], $reihe1, $top, 55, 17)
$lbl_script = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][45], $reihe3, $top, $breite3, 17)
$lbl_profil = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][46], $reihe1, $top, 85, 17)
$lbl_geboren = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][49], $reihe3, $top, 55, 17)
$lbl_AmtsBez = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel($texts[$language][50], $reihe1, $top, 85, 17)
$lbl_pwchange = GUICtrlCreateLabel("", $reihe2, $top, $breite1, 17)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel($texts[$language][51], $reihe3, $top, 55, 17)
$lblSex = GUICtrlCreateLabel("", $reihe4, $top, $breite4, 17)
GUICtrlSetFont(-1, -1, 800)

$top += 25
$listGroups = GUICtrlCreateListView($texts[$language][53], 8, $top, 800, 770 - $top)
	...
	If $user <> "" Then
		...
		Switch _ADObjectExists($user)
			...
			Case 0 ; User not found
				_GUICtrlStatusBar_SetText($sbSearchAD, $texts[$language][63] & $user & $texts[$language][64])
				$loopflag = 1
				Return 0
		EndSwitch
	EndIf
...
#CS Func DB_Abfrage($user)
	...
	; 	GUICtrlSetData($lblSex, $rs.Fields("Geschlecht").Value)
