...
Func searchDepartmentUsers()
	...
	$btnColleagueCompare = GUICtrlCreateButton("Compare groups with this colleague", $spacer, ($lvHeight+$spacer) + $btnHeight, $btnWidth, $btnHeight)
	$btnColleagueSwitch = GUICtrlCreateButton("Switch to this colleague", $spacer, ($lvHeight+$spacer) + (2*$btnHeight), $btnWidth, $btnHeight)
	$btnNeighbours_ok = GUICtrlCreateButton("Ok", $spacer, ($lvHeight+$spacer) + (3*$btnHeight), $btnWidth, $btnHeight)
