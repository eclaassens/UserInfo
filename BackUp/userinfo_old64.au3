...
Local $frmWidth = 650
	...
	$btnColleagueCompare = GUICtrlCreateButton("Compare groups with this colleague", $spacer, -1 + $btnHeight, $btnWidth, $btnHeight)
	$btnColleagueSwitch = GUICtrlCreateButton("Switch to this colleague", $spacer, -1 + $btnHeight, $btnWidth, $btnHeight)
	$btnNeighbours_ok = GUICtrlCreateButton("Ok", $spacer, -1 + $btnHeight, $btnWidth, $btnHeight)
