...
Func compareGroup($compareUser = "")
	...
	$data = FileOpen(@TempDir & "\userinfo.htm", 2)
	FileWriteLine($data, "<style> table.table{ font-family: "Trebuchet MS", sans-serif; font-size: 16px; font-weight: bold; line-height: 1.4em; font-style: normal; border-collapse:separate; } .table thead th{ padding:15px; color:#fff; text-shadow:1px 1px 1px #568F23; border:1px solid #93CE37; border-bottom:3px solid #9ED929; background-color:#9DD929; background:-webkit-gradient( linear, left bottom, left top, color-stop(0.02, rgb(123,192,67)), color-stop(0.51, rgb(139,198,66)), color-stop(0.87, rgb(158,217,41)) ); background: -moz-linear-gradient( center bottom, rgb(123,192,67) 2%, rgb(139,198,66) 51%, rgb(158,217,41) 87% ); -webkit-border-top-left-radius:5px; -webkit-border-top-right-radius:5px; -moz-border-radius:5px 5px 0px 0px; border-top-left-radius:5px; border-top-right-radius:5px; } .table tbody th{ color:#fff; background-color:#9DD929; border:1px solid #93CE37; padding:0px 10px; -moz-border-radius:5px 5px 5px 5px; -webkit-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; } .table tfoot td{ color: #9CD009; font-size:16px; text-align:center; padding:10px 0px; } .table tbody td{ padding:10px; text-align:center; background-color:#DEF3CA; border: 2px solid #E7EFE0; -moz-border-radius:2px; -webkit-border-radius:2px; border-radius:2px; color:#666; } </style>
")
