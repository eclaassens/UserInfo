...
$frmMain = GUICreate($titel, 1000, 700, -1, -1, $WS_SIZEBOX + $WS_SYSMENU + $WS_MAXIMIZEBOX)
...
$top += 25
$listGroups = GUICtrlCreateListView("Groupname|samAccountName|Group type|Member of|Scope", $col1LabelLeft, $top, 2 * $labelWidth + 2 * $valueWidthLong + 2* $cellPadding, 500)
