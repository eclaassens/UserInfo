...
Func _ADGetGroupMembers($group)
	...
	_GUICtrlStatusBar_SetText($sbMain, "Getting group members for " & $group & " ...this can take a while.")
	SplashTextOn("Zzzzz", "Please wait while minions are rumbling through the AD", "-1", "-1", "-1", "-1", 33, "", "", "")
	...
	FileWriteLine($data, "</style></head><title>Members of "& $group &"</title><body> <table class=table align=center><tbody>")
