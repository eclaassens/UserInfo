...
Func _ADGetGroupMembers($group)
	...
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Groupname" & ":</th><td bgcolor=66ff66 colspan=10>" & $group & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Created" & ":</th><td bgcolor=66ff66 colspan=10>" & $erzeugt & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Last changed" & ":</th><td bgcolor=66ff66 colspan=10>" & $geaendert & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "mail" & ":</th><td bgcolor=66ff66 colspan=10>" & $objGroup.mail & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Group info" & ":</th><td bgcolor=66ff66 colspan=10>" & $objGroup.info & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Description" & ":</th><td bgcolor=66ff66 colspan=10>" & $objGroup.description & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Scope of the group" & ":</th><td bgcolor=66ff66 colspan=10>" & $x & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Group class" & ":</th><td bgcolor=66ff66 colspan=10>" & $z & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Member count" & ":</th><td bgcolor=66ff66 colspan=10>" & UBound($userarry) - 1 & "</td></tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Groupmembers by Name" & ":</th>" & $result1 & "</tr>")
	FileWriteLine($datei, "<tr><th bgcolor=ff6666>" & "Groupmembers by UserID" & ":</th>" & $result2 & "</tr>")
	FileWriteLine($datei, "</table>")
	FileClose($datei)
