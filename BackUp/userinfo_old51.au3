...
Func _ADGetGroupMembers($group)
	...
	FileWriteLine($data, "<tr><th>" & "Scope of the group" & ":</th><td colspan=10>" & $groupScope & "</td></tr>")
	FileWriteLine($data, "<tr><th>" & "Group class" & ":</th><td colspan=10>" & $groupType & "</td></tr>")
	FileWriteLine($data, "<tr><th>" & "Member count" & ":</th><td colspan=10>" & UBound($arrayMembers) & "</td></tr>")
