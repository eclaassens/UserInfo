...
$reihe2 = 110 			; Start first value
$col2LabelLeft = 410 	; Start  second label
$reihe4 = 480 			; Start  second value
...
Global Const $padding = 5

$frmMain = GUICreate($titel, 980, 800, -1, -1)
GUISetBkColor(0xeeeeee)
GUICtrlSetFont($frmMain, 6)

GUICtrlCreateGroup("Functions", 820, $padding, $buttonWidth + (2 * $padding) , 770) ;Create Functions group
...
$top += 20
$bn_gruppenmitglieder = GUICtrlCreateButton("Group-Info", $buttonLeft, $top, $buttonWidth, $buttonNormalHeight)
...
; Create all info lables
$top = 10
GUICtrlCreateLabel("Name:", $col1LabelLeft, $top, 90, $labelHeight)
$lblName = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("UserID:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lblUserId = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Title:", $col1LabelLeft, $top, 90, $labelHeight)
$lbl_anrede = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("OU:", $col1LabelLeft, $top, 90, $labelHeight)
$lbl_ou = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Telephone:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lbl_telefon = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Department:", $col1LabelLeft, $top, 69, $labelHeight)
$lblDepartment = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Domain:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lblDomain = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Email:", $col1LabelLeft, $top, 28, $labelHeight)
$lbl_email = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Location:", $col2LabelLeft, $top, 69, $labelHeight)
$lbl_ort = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Address:", $col1LabelLeft, $top, 90, $labelHeight)
$lbl_adresse = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Room:", $col2LabelLeft, $top, 69, $labelHeight)
$lbl_raum = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$breite4 = 330
$top += 20
GUICtrlCreateLabel("Last update:", $col1LabelLeft, $top, 90, $labelHeight)
$lblLastUpdate = GUICtrlCreateLabel("", $reihe2, $top, 130, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Valid till:", $col1LabelLeft + 220, $top, 55, $labelHeight)
$lbl_expiration = GUICtrlCreateLabel("", $col1LabelLeft + 280, $top, 130, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("PW Required:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lblPwRequired = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("PW Change:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lbl_change = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Locked/Deact:", $col1LabelLeft, $top, 85, $labelHeight)
$lblLocked = GUICtrlCreateLabel("", $reihe2, $top, 30, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
GUICtrlCreateLabel("/", $reihe2 + 30, $top, 5, $labelHeight)
$lblDeactivated = GUICtrlCreateLabel("-", $reihe2 + 40, $top, 50, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$bn_unlock = GUICtrlCreateButton("Unlock", 200, $top - 4, 90, 20)

GUICtrlCreateLabel("Created on:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lbl_erzeugt = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Failed count:", $col1LabelLeft, $top, 85, $labelHeight)
$lbl_errorcount = GUICtrlCreateLabel("", $reihe2, $top, 85, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Last logon:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lbl_login = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Homedirectory:", $col1LabelLeft, $top, 89, $labelHeight)
$lbl_homeverz = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Homedrive:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lbl_homelauf = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Loginscript:", $col1LabelLeft, $top, 55, $labelHeight)
$lblLogonScript = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Profile Path:", $col2LabelLeft, $top, $breite3, $labelHeight)
$lbl_profil = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

#CS $top += 20
; GUICtrlCreateLabel("Born on:", $col1LabelLeft, $top, 85, $labelHeight)
; $lbl_geboren = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
; GUICtrlSetFont(-1, -1, 800)
;
; GUICtrlCreateLabel("Rank:", $col2LabelLeft, $top, 55, $labelHeight)
; $lbl_AmtsBez = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
; GUICtrlSetFont(-1, -1, 800)
;
; $top += 20
; GUICtrlCreateLabel("PWchange", $col1LabelLeft, $top, 85, $labelHeight)
; $lbl_pwchange = GUICtrlCreateLabel("", $reihe2, $top, $breite1, $labelHeight)
; GUICtrlSetFont(-1, -1, 800)
;
; GUICtrlCreateLabel("Sex:", $col2LabelLeft, $top, 55, $labelHeight)
; $lblSex = GUICtrlCreateLabel("", $reihe4, $top, $breite4, $labelHeight)
; GUICtrlSetFont(-1, -1, 800)
 #CE
...
Func listDomains() ; get all known Domains and select ours
	$oDS = ObjGet("WinNT:")
	$top = ""
	For $x In $oDS
		$top = $top & "|" & $x.Name
	Next
	GUICtrlSetData($cmbDomain, $top, "NL")
EndFunc   ;==>listDomains

Func setUser($userid_tmp = "")
	ControlFocus($titel, "", $btnNewQuery)
	_GUICtrlStatusBar_SetText($sbSearchAD, "Waiting for input...")
	$pc = ""
	$lw_m = ""
	...
	_GUICtrlStatusBar_SetText($sbSearchAD, $texts[$language][59])
		...
		Switch $nMsg
			...
			Case $bn_gruppenmitglieder
				...
				If $x <> "" Then ; nur wenn auch ein User gewählt wurde...
					$top = GUICtrlRead($x) ; das ListviewItem auslesen
					$tmp = StringSplit($top, "|") ; aufteilen und nur die UserID behalten
			...
			Case Else
				...
				If $tmp <> "" Then ; only if a text has been detected
					...
					_GUICtrlStatusBar_SetText($sbSearchAD, $tmp & $texts[$language][60]) ; update status bar
...
Func finde_domaene($user = "", $domain = "")
	...
	If $user <> "" Then
		...
		If @error Then
			_GUICtrlStatusBar_SetText($sbSearchAD, $texts[$language][61] & $domain & $texts[$language][62])
			$loopflag = 1
			Return 0
		EndIf
...
Func queryAD()
	...
	_GUICtrlStatusBar_SetText($sbSearchAD, $texts[$language][66] & $tmp2 & $texts[$language][67] & $tmp1 & $texts[$language][68] & $strHostServer)
EndFunc   ;==>queryAD
