...
$frmMain = GUICreate($titel, 980, 800, -1, -1, $WS_SIZEBOX + $WS_SYSMENU + $WS_MAXIMIZEBOX)
...
GUICtrlSetResizing(-1, $GUI_DOCKTOP + $GUI_DOCKRIGHT + $GUI_DOCKVCENTER $GUI_)

$top += 40
$btnNewQuery = GUICtrlCreateButton("New Search", $buttonLeft, $top, $buttonWidth, $buttonBigHeight)
GUICtrlSetImage(-1, "shell32.dll", 23)
GUICtrlSetResizing(-1, $GUI_DOCKTOP + $GUI_DOCKVCENTER + $GUI_DOCKRIGHT)
...
GUICtrlSetResizing(-1, $GUI_DOCKTOP + $GUI_DOCKVCENTER + $GUI_DOCKLEFT)
...
$cmbDomain = GUICtrlCreateCombo("US", 110, 62, 250, 250, $CBS_DROPDOWNLIST)
