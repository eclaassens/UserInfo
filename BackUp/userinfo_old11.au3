...
$valueWidth = 300 ; default value width
...
$lblOU = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Telephone:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblTelephone = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
$lblEmail = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Location:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblLocation = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Address:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblAddress = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Office:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblOffice = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

$top += 20
GUICtrlCreateLabel("Last update:", $col1LabelLeft, $top, $labelWidth, $labelHeight)
$lblLastUpdate = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidth / 2, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Valid till:", $col1ValueLeft + ($valueWidth / 2), $top, $labelWidth / 2, $labelHeight)
$lblExpiration = GUICtrlCreateLabel("", $col1ValueLeft + ($valueWidth / 2) + ($labelWidth / 2), $top, $valueWidth / 2, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
$btnUnlock = GUICtrlCreateButton("Unlock", 200, $top - 4, $labelWidth, 20)
...
$lblBadLoginCount = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidth / 4, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
$lblHomeDirectory = GUICtrlCreateLabel("", $col1ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)

GUICtrlCreateLabel("Homedrive:", $col2LabelLeft, $top, $labelWidth, $labelHeight)
$lblHomeDrive = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
$lblProfilePath = GUICtrlCreateLabel("", $col2ValueLeft, $top, $valueWidth, $labelHeight)
GUICtrlSetFont(-1, -1, 800)
...
Func _ADGetAccount($user)
	...
	For $oACE In $oACL
		If ($oACE.ObjectType = $USER_CHANGE_PASSWORD) And (($oACE.Trustee = "Everyone") Or ($oACE.Trustee = "Iedereen")) Then
			If ($oACE.AceType = $ADS_ACETYPE_ACCESS_ALLOWED_OBJECT) Then
				GUICtrlSetData($lbl_change, "Allowed")
				GUICtrlSetColor($lbl_change, 0x00aa00)
			Else
				GUICtrlSetData($lbl_change, "Locked")
	...
	If ($tmp2 < 1) And ($tmp2 > -148883) Then GUICtrlSetColor($lblExpiration, 0xff0000) ; Passwort ist keinen Tag mehr gültig
...
Func searchDepartment()
	...
	For $i = 0 To UBound($treffer_array) - 1 ; und alle Ergebnisse in Listview kopieren
		...
		If $wert[1] = $office Then GUICtrlSetBkColor($x, 0xffff00) ; die Raumnummer des Users einfärben
	Next
