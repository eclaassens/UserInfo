...
Func compareGroup($compareUser = "")
	...
	FileWriteLine($data, ".table tfoot td{ color: #9CD009; font-size:16px; text-align:center; padding:10px 0px; } .table tbody td{ padding:10px; text-align:center; background-color:#DEF3CA; border: 2px solid #E7EFE0; -moz-border-radius:2px; -webkit-border-radius:2px; border-radius:2px; color:#666; }")
	FileWriteLine($data, "</style>")
